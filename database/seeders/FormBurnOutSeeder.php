    ...
    public function run()
    {
        ...
        DB::table('formularios')->insert([
            [
                ...
                'instrucoes' => '<p>Responda com toda a sinceridade, sabendo que o sigilo da sua identidade é absoluto e garantido por nós, e que seu feedback é indispensável para construir um ambiente de trabalho mais sustentável e positivo para todos. Você está em um espaço 100% seguro, e cada resposta é valiosa para elevar sua qualidade de vida. </p><p>Use a escala de 1 a 5, onde:</p><ul><li>1 - Uma vez por mês ou menos</li><li>2 - Algumas vezes por mês</li><li>3 - Uma vez por semana</li><li>4 - Algumas vezes por semana</li><li>5 - Todos os dias</li></ul>',
                'score_ini' => 1,
                'score_fim' => 5,
                'calculo_id' => 1,
                'status' => 0,
