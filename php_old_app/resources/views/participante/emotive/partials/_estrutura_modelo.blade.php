...
@endif
    ...
    <div style="text-align: center; page-break-inside: avoid; flex: 1; display: flex; align-items: center; justify-content: center;">
        <img src="{{ $imgPath('img/imagen_rel_emotive.png') }}" style="max-width: 100%; max-height: 100%; height: auto; margin: 0 auto; display: block; object-fit: contain;" alt="Estrutura do Modelo E.MO.TI.VE">
    </div>
    @if($isPdfMode)
    </div>
    @include('participante.emotive.partials._footer_pdf', ['pageNumber' => '02'])
    @else
    <!-- Footer -->
