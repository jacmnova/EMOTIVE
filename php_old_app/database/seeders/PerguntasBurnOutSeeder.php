    ...
    public function run()
    {
        ...
        // PESQUISA GERAL 
            ...
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 1,
                'pergunta' => 'Estou me sentindo mentalmente exausto(a) devido às exigências do meu trabalho.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
        ...
        // PESQUISA DE SERVIÇO 
            ...
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 15,
                'pergunta' => 'Tenho certa dificuldade em me importar com todos os usuários que se beneficiam do meu trabalho.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
            ...
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 17,
                'pergunta' => 'Crio um ambiente acolhedor e tranquilo para as pessoas que atendo.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 18,
                'pergunta' => 'Ganho ânimo e motivação ao interagir diretamente com as pessoas que se beneficiam do meu trabalho.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
            ...
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 22,
                'pergunta' => 'Sinto que os usuários dos meus serviços às vezes projetam em mim a responsabilidade por seus problemas.',
                'created_at' => now(),
            ],
        ...
        // Questionario II - Adriana
            ...
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 1,
                'pergunta' => 'Sinto-me esgotado(a) ao final do dia.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 2,
                'pergunta' => 'Sinto-me sobrecarregado(a) com o volume de trabalho.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 3,
                'pergunta' => 'Não tenho energia para enfrentar o dia seguinte.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 4,
                'pergunta' => 'Tenho dificuldade para me recuperar emocionalmente.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 5,
                'pergunta' => 'Sinto-me emocionalmente distante do que faço.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 6,
                'pergunta' => 'Torno-me indiferente às demandas que recebo.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 7,
                'pergunta' => 'Percebo que trato as pessoas de forma impessoal.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 8,
                'pergunta' => 'Meu envolvimento emocional com o trabalho é baixo.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 9,
                'pergunta' => 'Tenho a sensação de que realizo pouco no meu trabalho.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 10,
                'pergunta' => 'Sinto dúvidas em relação à minha competência.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 11,
                'pergunta' => 'Cobro demais de mim mesmo(a) o tempo todo.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 12,
                'pergunta' => 'Sinto que estou sacrificando minha saúde em função do trabalho.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 13,
                'pergunta' => 'Percebo que tenho pouca autonomia para tomar decisões.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 14,
                'pergunta' => 'Já vivenciei situações de assédio ou pressão excessiva.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 15,
                'pergunta' => 'Sou alvo de piadas ou críticas desrespeitosas.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 16,
                'pergunta' => 'Sinto que sou tratado(a) de maneira injusta.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 17,
                'pergunta' => 'Já testemunhei colegas sendo humilhados.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 18,
                'pergunta' => 'Tenho medo de me expressar no ambiente de trabalho.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 19,
                'pergunta' => 'Sinto-me excluído(a) de decisões importantes.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 20,
                'pergunta' => 'Já recebi ameaças veladas ou explícitas.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 21,
                'pergunta' => 'Costumo fazer horas extras com frequência.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 22,
                'pergunta' => 'Sinto que as metas definidas são inalcançáveis.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 23,
                'pergunta' => 'Tenho dificuldade para tirar férias ou fazer pausas regulares.',
                'created_at' => now(),
            ],
            [
                'formulario_id' => 1,
            ...
            [
                'formulario_id' => 1,
                'numero_da_pergunta' => 25,
                'pergunta' => 'Percebo que minha vida pessoal tem sido comprometida pelo trabalho.',
                'created_at' => now(),
            ],
